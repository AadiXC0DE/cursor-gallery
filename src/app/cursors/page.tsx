...
export const metadata = {
  ...
  description: "Browse our full collection of custom animated cursors for your web projects.",
}
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 pt-24 pb-20">
        <div className="container mx-auto px-4 mb-12 text-center">
            <h1 className="text-4xl font-bold tracking-tight mb-4">All Cursors</h1>
