        ...
        <section id="gallery" className="py-24 relative overflow-hidden bg-muted/20">
            <div className="container mx-auto px-4 mb-16 text-center max-w-3xl">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-muted border border-border mb-6">
                    <span className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground">Featured Gallery</span>
                </div>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-12">
                    <div className="max-w-xl">
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 mb-6">
                            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-primary">CLI Support</span>
                        </div>
                        ...
                        <p className="text-muted-foreground text-lg font-medium leading-relaxed mb-8">
                            ...
                            Install any cursor directly into your <code className="text-primary font-bold">components/cursor</code> folder with one command.
                        </p>
                    </div>
                            ...
                            <div className="relative bg-[#0d0d0d] rounded-xl border border-white/10 overflow-hidden shadow-2xl">
                                <div className="flex items-center gap-2 px-4 py-3 border-b border-white/5 bg-white/5">
                                    ...
                                    <div className="flex-1 text-center">
                                        <span className="text-[10px] font-black text-white/30 uppercase tracking-[0.2em]">Terminal</span>
                                    </div>
                                </div>
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div className="space-y-4">
                                            <p className="text-white/90 leading-relaxed font-bold">
                                                npx shadcn@latest add <span className="text-primary">https://cursor-gallery.vercel.app/registry/index.json</span>
                                            </p>
                                            <div className="space-y-1">
                                                <p className="text-white/40 text-xs italic"># Fetches 100+ premium animated cursors</p>
                                                <p className="text-white/40 text-xs italic"># Dependencies installed automatically</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
