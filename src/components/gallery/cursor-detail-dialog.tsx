...
export function CursorDetailDialog({
  cursor,
  isOpen,
  onClose,
}: CursorDetailDialogProps) {
    ...
    fetch(`/api/cursor-code?id=${cursor.id}`)
      ...
      .catch((err) => {
        if (!cancelled) {
          ...
          setIsLoadingCode(false);
          setActualCode({
            react: cursor.code.react,
            vanilla: cursor.code.vanilla,
          });
        }
      });
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  {cursor.tags.map((tag) => (
                    <span
                      key={tag}
                      className="px-2 py-1 bg-secondary/50 text-secondary-foreground rounded text-[10px] font-bold uppercase tracking-wider border border-border/50"
                    >
                      #{tag}
                    </span>
                  ))}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pb-4">
                    <div className="space-y-6">
                      ...
                      <div className="space-y-3">
                        ...
                        <p className="text-[11px] text-muted-foreground leading-relaxed">
                          Import and place the cursor at the root of your
                          application (e.g.,{" "}
                          <code className="text-primary">layout.tsx</code> or{" "}
                          <code className="text-primary">App.tsx</code>).
                        </p>
                      </div>
                      <div className="space-y-3">
                        <div className="flex items-center gap-2">
                          ...
                          <h4 className="text-xs font-black uppercase tracking-widest">
                            Step 3: Hide System Cursor
                          </h4>
                        </div>
                        <p className="text-[11px] text-muted-foreground leading-relaxed">
                          Add the utility class{" "}
                          <code className="text-primary">.custom-cursor</code>{" "}
                          to your root HTML/Body.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div className="p-4 rounded-xl border border-primary/20 bg-primary/5 space-y-3">
                        ...
                        <p className="text-[10px] text-muted-foreground font-medium italic">
                          Prevent the system &ldquo;finger/pointer&rdquo; from
                          appearing on buttons/links by adding this to your{" "}
                          <b>globals.css</b>:
                        </p>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[10px] text-primary font-mono truncate">
                      npx shadcn add .../registry/cursor-{cursor.id}
                    </p>
                  </div>
