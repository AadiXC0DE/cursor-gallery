...
import { MousePointer2, Zap, Palette, Code2, Download, Component } from "lucide-react"

const FEATURES = [
  {
    icon: MousePointer2,
    title: "Visual First",
    description: "Browse cursors visually. Hover to preview instantly on your own screen."
  },
  {
    icon: Code2,
  ...
  },
  {
    icon: Zap,
    title: "Zero Config",
    description: "Drop into any Next.js, Vite, or Cra project. No complex setup required."
  },
  {
    icon: Palette,
    title: "Theme Aware",
  ...
  },
  {
    icon: Component,
    title: "Performance",
    description: "Lightweight animations powered by CSS transforms and requestAnimationFrame."
  },
  {
    icon: Download,
    title: "Open Source",
        ...
        <div className="container mx-auto px-4">
            <div className="max-w-3xl mb-24">
                ...
                <p className="text-muted-foreground text-lg font-medium max-w-xl">
                    Everything is built for performance and absolute control. 
                    Every cursor is optimized for high-refresh-rate displays.
                </p>
            </div>
                ...
                {FEATURES.map((feature, idx) => (
                    <div key={idx} className="group relative flex flex-col gap-6">
                        ...
                        <div className="space-y-3">
                            <h3 className="font-black text-xl uppercase italic tracking-tighter text-foreground">{feature.title}</h3>
