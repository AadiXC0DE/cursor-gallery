    ...
    >
      <div className="relative">
        <svg width="36" height="36" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          {/* Ears (Floppy) */}
          <path d="M5 8C5 8 2 10 3 14" stroke="#78350f" strokeWidth="2" strokeLinecap="round" fill="#b45309"/>
          <path d="M19 8C19 8 22 10 21 14" stroke="#78350f" strokeWidth="2" strokeLinecap="round" fill="#b45309"/>
          
          {/* Face */}
          <rect x="5" y="7" width="14" height="12" rx="6" fill="#fbbf24" stroke="#78350f" strokeWidth="2" />
