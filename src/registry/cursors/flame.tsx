...
export default function FlameCursor({ x, y, isStatic }: { x: number; y: number; isStatic?: boolean }) {
    ...
    <>
      ...
      >
        <svg width="24" height="32" viewBox="0 0 24 32" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          />
          <defs>
            <radialGradient id="flame-grad" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(12 20) rotate(90) scale(12 12)">
